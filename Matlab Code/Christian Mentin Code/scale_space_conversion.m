function [ imDOG, imBlob ] = scale_space_conversion( Input_Image )
...
% figure;imshow(im2bw(scale_space_array(:,:,:,1),0.15));
% figure;imshow(im2bw(scale_space_array(:,:,:,6),0.15));

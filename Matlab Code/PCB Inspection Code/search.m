function [ matches_found, Input_Image_removed_features ] = search( Input_Image, Element_of_Interest, type, tolerance,plot_ON )
...
for rotation = 1:1:2;
    ...
    %figure;surf(convolution_mtx);title('convolution 1');
                    ...
                    if maxima(x,y) > 0 % juste un point 
                        ...
                        for x1 = 1:1:size(Element_of_Interest,1);
                          for y1 = 1:1:size(Element_of_Interest,2);
                            %supprimer les élements trouvés
